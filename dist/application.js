...
exports.default = function (state, action) {
    switch (action.type) {
        case _actions_1.SAVE_APP_BASE_RESULT:
            var perPage = action.payload.config.itemsPerPage;
            return __assign({}, state, { loadMessage: "groupItems", applicationBaseResult: __assign({}, action.payload, { config: __assign({}, action.payload.config, { itemsPerPage: typeof perPage === "number" && perPage > 0 ? perPage : 20 }) }) });
