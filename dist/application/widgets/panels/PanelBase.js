define(["require", "exports", "esri/widgets/support/widget"], function (require, exports, widget_1) {
    ...
    exports.default = function (props) {
        var author = props.config.showAuthor ? (widget_1.jsxFactory.createElement("p", { class: "font-size--1 card-last hug-bottom", key: props.item.title + "-author" }, props.item.owner)) : null;
        var PanelBaseComponent = {
            captionOpacity: 1,
            captionTransform: 0,
            render: function () {
                var caption = props.config.showItemType ? (widget_1.jsxFactory.createElement("div", { class: "card-image-caption", style: "\n                        opacity: " + PanelBaseComponent.captionOpacity + ";\n                        transform: translate(0, " + PanelBaseComponent.captionTransform + "%);\n                        background-color: " + convertHex(props.captionColor, 80) + ";\n                        color: " + props.config.captionTextColor + "\n                    " }, props.item.displayName)) : null;
                return (widget_1.jsxFactory.createElement("div", { class: "card block trailer-1 animate-fade-in card-fade", style: "background-color: " + props.config.cardColor + ";", key: props.item.title + "-div" },
                    ...
                    widget_1.jsxFactory.createElement("div", { class: "card-content", style: "color: " + props.config.fontColor },
                        ...
                        widget_1.jsxFactory.createElement("div", { class: "open-out-container" },
                            widget_1.jsxFactory.createElement("a", { class: "open-out-icon btn btn-transparent icon-ui-description", title: props.extItem, href: props.extLink, style: "color: " + props.config.buttonBgColor, key: props.item.title + "-info-icon" }),
                            widget_1.jsxFactory.createElement("a", { class: "open-out-icon btn btn-transparent icon-ui-maximize", title: props.extTitle, href: props.maxLink, style: "color: " + props.config.buttonBgColor, key: props.item.title + "-open-out-icon" })))));
            }
        };
