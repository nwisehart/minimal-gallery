    ...
    exports.default = function (props) {
        ...
        return {
            render: function () {
                ...
                return (widget_1.jsxFactory.createElement("div", { class: "text-center trailer-1 leader-1", key: "pager-" + props.total },
                    widget_1.jsxFactory.createElement("a", { id: "previous", title: "previous", classes: prevButtonClasses, onclick: handlePrevious, role: "link", tabindex: "0", style: "color:" + props.config.buttonBgColor + ";", key: "previous-button-" + props.keyCode }, "Previous"),
                    pageButtons.map(function (button) { return button.render(); }),
                    widget_1.jsxFactory.createElement("a", { id: "next", title: "next", classes: nextButtonClasses, onclick: handleNext, role: "link", tabindex: "0", style: "color:" + props.config.buttonBgColor + ";", key: "next-button-" + props.keyCode }, "Next")));
            }
        };
